...
const Register = () => {
    ...
    const { createNewAccount, loginGoogle } = useContext(AuthContext)
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="flex items-center justify-center mt-40">
                <form onSubmit={handleRegister} className="bg-gray-900 border-[4px] border-blue-900 rounded-2xl hover:border-blue-500 transition-all duration-200">
                    <div className="form-control mx-auto flex items-center space-y-4 py-16 px-12 font-semibold text-gray-500 flex-col">
                        ...
                        <button className='w-full p-2 bg-gray-50 rounded-full font-bold text-gray-900 border-[4px] border-gray-700 hover:border-blue-500 transition-all duration-200'>Register</button>
                        <p> You have an account? <Link to={'/login'} className="font-semibold text-white hover:text-blue-500 transition-all duration-200" href>Login</Link></p>
                        {/* log in with google */}
                        <button onClick={handleGoogle} className="flex items-center justify-center py-2 px-5 rounded-full bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2">
